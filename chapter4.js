...
function Game1_Abacus({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "mascot-sm"
  }, /*#__PURE__*/React.createElement(MascotBunny, {
    size: 84
  })), /*#__PURE__*/React.createElement("div", {
    className: "bubble"
  }, "\u8BF7\u5728\u8BA1\u6570\u5668\u4E0A\u62E8\u51FA ", /*#__PURE__*/React.createElement("span", {
    className: "num",
    style: {
      color: "var(--sky-deep)",
      fontSize: 32,
    ...
    }, c.name, "\u4F4D"), /*#__PURE__*/React.createElement("div", {
      style: {
        position: "relative",
        width: 50,
        height: 240,
    ...
    style: {
      fontSize: 34,
      color: locked ? current === target ? "var(--mint-deep)" : "var(--coral-deep)" : "var(--ink)"
    }
  }, "\u5F53\u524D\uFF1A", current, locked && current === target && " ✓", locked && current !== target && ` ✗ 正确答案：${target}`)), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center"
    }
  }, /*#__PURE__*/React.createElement("button", {
    ...
    onClick: submit,
    disabled: locked
  }, "\u5C31\u662F\u8FD9\u4E2A\u6570\uFF01")), /*#__PURE__*/React.createElement(RoundNav, {
    round: round,
    total: TOTAL,
    setRound: setRound,
...
function Game2_Read({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "bubble"
  }, q.ask === "digits" ? "这个数读作下面哪一个数？" : "这个数怎么读？")), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, q.display)), /*#__PURE__*/React.createElement(OptionGrid, {
    key: round,
    options: q.options,
    correct: q.correct,
    onResolved: resolve,
...
function Fish({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    fontWeight: "800",
    fontSize: size === "big" ? 36 : 28,
    fill: "#fff"
  }, value));
}
function Game3_Compare({
  onWin
}) {
  const TOTAL = 9;
  const [round, setRound] = useState(0);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "bubble"
  }, "\u5927\u9C7C\u8981\u5403\u5C0F\u9C7C\uFF0C\u5F20\u5F00\u5634\u5BF9\u51C6\u8C01\uFF1F\u9009\u51FA\u6B63\u786E\u7684\u6BD4\u8F83\u7B26\u53F7\uFF01")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      justifyContent: "center",
      alignItems: "center",
...
function Chapter4({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "chapter-screen chapter-bg-c4"
  }, /*#__PURE__*/React.createElement("div", {
    className: "chapter-body"
  }, /*#__PURE__*/React.createElement("div", {
    className: "stage-tabs"
  }, ["拨计数器", "读与写", "比大小"].map((t, i) => /*#__PURE__*/React.createElement("button", {
    key: i,
    className: `stage-tab ${i === stage ? "active" : ""}`,
    onClick: () => setStage(i)
  }, i < stage && /*#__PURE__*/React.createElement(StarIcon, {
    size: 16
  }), " ", t))), stage === 0 && /*#__PURE__*/React.createElement(Game1_Abacus, {
    key: "g1",
    onWin: finish
  }), stage === 1 && /*#__PURE__*/React.createElement(Game2_Read, {
    key: "g2",
    onWin: finish
  }), stage === 2 && /*#__PURE__*/React.createElement(Game3_Compare, {
    key: "g3",
    onWin: finish
